...
class AddProductSectionWidget extends StatelessWidget {
  ...
  final int? index;
  const AddProductSectionWidget({super.key, this.title, required this.childrens, this.titleStyle, this.isDecoration = true, this.aiWidget, this.isAiGenerating, this.childrenPadding, this.subTitle, this.button, this.isRequired = false, this.index});
  ...
  Widget build(BuildContext context) {
    ...
    if (index != null) {
      return widget.animateSectionEntrance(index: index!);
    }
    return widget;
  }
}
