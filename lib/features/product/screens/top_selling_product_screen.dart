...
import 'package:syriacosmeticsmanger/common/basewidgets/title_row_widget.dart';
import 'package:syriacosmeticsmanger/features/product/screens/product_list_view_screen.dart';
import 'package:syriacosmeticsmanger/features/product/widgets/top_most_product_card_widget.dart';
              ...
              child: PaginatedListViewWidget(
                ...
                itemView: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return TopMostProductWidget(productModel: productList![index].product, totalSold: productList[index].product?.totalQtySold.toString()).animateListEntrance(index);
                  },
                ),
              ),
