...
import 'package:syriacosmeticsmanger/features/addProduct/domain/models/brand_model.dart';
import 'package:syriacosmeticsmanger/features/addProduct/domain/models/category_model.dart';
import 'package:syriacosmeticsmanger/features/product/controllers/category_controller.dart';
import 'package:syriacosmeticsmanger/features/product/domain/enums/product_type_enum.dart';
...
import 'package:syriacosmeticsmanger/features/product/domain/models/srock_limit_model.dart';
import 'package:syriacosmeticsmanger/features/product/domain/services/product_service_interface.dart';
import 'package:syriacosmeticsmanger/features/product/domain/models/top_selling_product_model.dart';
...
class ProductController extends ChangeNotifier {
  ...
  //     await productServiceInterface.getStockLimitedProductList(
  //         offset, languageCode);
  //
  ...
  //
  //         _stockOutProductList!.addAll(productModel.products!);
  //
  //         _stockOutProductPageSize = productModel.totalSize;
  //
  //       } else {
  //
  //         // ===============================
  ...
  //               path: 'https://picsum.photos/200?1',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  ...
  //             variation: [],
  //             thumbnailFullUrl: ImageFullUrl(
  //               path: 'https://picsum.photos/200?2',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  ...
  //             variation: [],
  //             thumbnailFullUrl: ImageFullUrl(
  //               path: 'https://picsum.photos/200?3',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  ...
  //             variation: [],
  //             thumbnailFullUrl: ImageFullUrl(
  //               path: 'https://picsum.photos/200?4',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  ...
  //             variation: [],
  //             thumbnailFullUrl: ImageFullUrl(
  //               path: 'https://picsum.photos/200?5',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  ...
  //             variation: [],
  //             thumbnailFullUrl: ImageFullUrl(
  //               path: 'https://picsum.photos/200?6',
  //               status: 200,
  //             ),
  //             reviews: [],
  //             reviewsCount: 0,
  //           ),
  //         ]);
  //         _stockOutProductPageSize = _stockOutProductList!.length;
  //       }
  //
  //       _isLoading = false;
  //       _isPaginationLoading = false;
