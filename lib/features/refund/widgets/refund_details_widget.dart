...
import 'package:syriacosmeticsmanger/features/refund/domain/models/refund_details_model.dart';
import 'package:syriacosmeticsmanger/features/refund/domain/models/refund_model.dart';
import 'package:syriacosmeticsmanger/features/refund/widgets/refund_attachment_list_widget.dart';
...
import 'package:syriacosmeticsmanger/features/refund/widgets/approve_reject_widget.dart';
import 'package:syriacosmeticsmanger/features/refund/widgets/customer_info_widget.dart';
import 'package:syriacosmeticsmanger/features/refund/widgets/delivery_man_info_widget.dart';
import 'package:syriacosmeticsmanger/features/refund/widgets/refund_pricing_widget.dart';
                    ...
                    builder: (context, refund, _) {
                      return Column(
                        ...
                        children: [
                          ...
                          RefundDataWidget(refundModel: widget.refundModel).animateSectionEntrance(index: 1),
                          ...
                          RefundPricingWidget(refundModel: widget.refundModel).animateSectionEntrance(index: 4),
                          const SizedBox(height: Dimensions.paddingSizeSmall),

                          widget.refundModel!.customer != null ?
                          CustomerInfoWidget(refundModel: widget.refundModel).animateSectionEntrance(index: 5) : Padding(
                          ...
                          DeliveryManInfoWidget(refundReq: refundReq).animateSectionEntrance(index: 6) : const SizedBox(),
