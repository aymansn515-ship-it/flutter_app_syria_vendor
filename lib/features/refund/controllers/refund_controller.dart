...
import 'package:syriacosmeticsmanger/features/refund/domain/services/refund_service_interface.dart';
  ...
  void setDummyRefundData() {
    ...
    _refundList = [
      RefundModel(
        ...
        status: 'pending',
        amount: 250,
        refundReason: 'The product arrived damaged',
    ...
    _pendingList = _refundList!
        .where((e) => e.status == 'pending')
        .toList();

    _approvedList = _refundList!
        .where((e) => e.status == 'approved')
        .toList();

    _doneList = _refundList!
