...
import 'package:syriacosmeticsmanger/features/home/screens/home_page_screen.dart';
import 'package:syriacosmeticsmanger/features/menu/widgets/menu_widget.dart';
import 'package:syriacosmeticsmanger/features/order/screens/order_screen.dart';
import 'package:syriacosmeticsmanger/features/refund/screens/refund_screen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        key: _scaffoldKey,
        extendBody: true, // 👈 مهم حتى يمشي المحتوى خلف الشريط ويشتغل تأثير الزجاج
            ...
            child: BackdropFilter(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor.withValues(alpha: 0.6), // الشفافية
                  borderRadius: BorderRadius.circular(28),
                ...
                child: BottomNavigationBar(
                  backgroundColor: Colors.transparent, // 👈 ضروري حتى يبين الزجاج
                  elevation: 0,
