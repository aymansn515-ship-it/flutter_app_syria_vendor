...
import 'package:syriacosmeticsmanger/features/ai/domain/repositories/ai_repository.dart';
import 'package:syriacosmeticsmanger/features/ai/domain/repositories/ai_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/ai/domain/services/ai_service.dart';
import 'package:syriacosmeticsmanger/features/ai/domain/services/ai_service_interface.dart';
import 'package:syriacosmeticsmanger/features/auth/domain/repositories/auth_repository.dart';
import 'package:syriacosmeticsmanger/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/auth/domain/services/auth_service.dart';
...
import 'package:syriacosmeticsmanger/features/bank_info/domain/services/bank_info_service.dart';
...
import 'package:syriacosmeticsmanger/features/barcode/domain/repositories/barcode_repository.dart';
import 'package:syriacosmeticsmanger/features/barcode/domain/repositories/barcode_reposity_interface.dart';
import 'package:syriacosmeticsmanger/features/barcode/domain/services/barcode_service.dart';
...
import 'package:syriacosmeticsmanger/features/chat/domain/services/chat_service.dart';
...
import 'package:syriacosmeticsmanger/features/clearance_sale/domain/repositories/clearance_sale_repository.dart';
import 'package:syriacosmeticsmanger/features/clearance_sale/domain/repositories/clearance_sale_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/clearance_sale/domain/services/clearance_sale_service.dart';
...
import 'package:syriacosmeticsmanger/features/coupon/domain/services/coupon_service.dart';
...
import 'package:syriacosmeticsmanger/features/delivery_man/domain/services/delivery_service.dart';
...
import 'package:syriacosmeticsmanger/features/emergency_contract/domain/services/emergency_service.dart';
import 'package:syriacosmeticsmanger/features/notification/controllers/notification_controller.dart';
import 'package:syriacosmeticsmanger/features/notification/domain/repositories/notification_repository.dart';
import 'package:syriacosmeticsmanger/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/notification/domain/services/notification_service.dart';
...
import 'package:syriacosmeticsmanger/features/order/domain/services/location_service.dart';
import 'package:syriacosmeticsmanger/features/order/domain/services/location_service_interface.dart';
import 'package:syriacosmeticsmanger/features/order/domain/services/order_service.dart';
...
import 'package:syriacosmeticsmanger/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:syriacosmeticsmanger/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/order_details/domain/services/order_details_service.dart';
...
import 'package:syriacosmeticsmanger/features/order_edit/domain/repositories/order_edit_repository.dart';
import 'package:syriacosmeticsmanger/features/order_edit/domain/repositories/order_edit_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/order_edit/domain/services/order_edit_service.dart';
...
import 'package:syriacosmeticsmanger/features/pos/domain/services/cart_service.dart';
...
import 'package:syriacosmeticsmanger/features/product/domain/repositories/category_repository.dart';
...
import 'package:syriacosmeticsmanger/features/product/domain/services/category_service.dart';
import 'package:syriacosmeticsmanger/features/product/domain/services/category_service_interface.dart';
import 'package:syriacosmeticsmanger/features/product/domain/services/product_service.dart';
import 'package:syriacosmeticsmanger/features/product_details/controllers/product_details_controller.dart';
import 'package:syriacosmeticsmanger/features/product_details/domain/repositories/product_details_repository.dart';
...
import 'package:syriacosmeticsmanger/features/product_details/domain/services/product_details_service.dart';
...
import 'package:syriacosmeticsmanger/features/profile/domain/services/profile_service.dart';
import 'package:syriacosmeticsmanger/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/refund/domain/services/refund_service.dart';
...
import 'package:syriacosmeticsmanger/features/restock/domain/repositories/restock_repository.dart';
import 'package:syriacosmeticsmanger/features/restock/domain/repositories/restock_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/restock/domain/services/restock_service.dart';
...
import 'package:syriacosmeticsmanger/features/review/domain/services/review_service.dart';
...
import 'package:syriacosmeticsmanger/features/settings/domain/repositories/business_repository.dart';
import 'package:syriacosmeticsmanger/features/pos/domain/repository/cart_repository.dart';
import 'package:syriacosmeticsmanger/features/chat/domain/repositories/chat_repository.dart';
import 'package:syriacosmeticsmanger/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:syriacosmeticsmanger/features/delivery_man/domain/repositories/delivery_man_repository.dart';
import 'package:syriacosmeticsmanger/features/emergency_contract/domain/repositories/emergency_contact_repository.dart';
import 'package:syriacosmeticsmanger/features/order/domain/repositories/location_repository.dart';
import 'package:syriacosmeticsmanger/features/order/domain/repositories/order_repository.dart';
import 'package:syriacosmeticsmanger/features/profile/domain/repositories/profile_repository.dart';
import 'package:syriacosmeticsmanger/features/refund/domain/repositories/refund_repository.dart';
import 'package:syriacosmeticsmanger/features/settings/domain/services/business_service.dart';
...
import 'package:syriacosmeticsmanger/features/shipping/domain/services/shipping_service.dart';
import 'package:syriacosmeticsmanger/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:syriacosmeticsmanger/features/addProduct/domain/repository/add_product_repository.dart';
import 'package:syriacosmeticsmanger/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:syriacosmeticsmanger/features/shop/domain/repositories/shop_repository.dart';
import 'package:syriacosmeticsmanger/features/addProduct/domain/repository/add_product_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/addProduct/domain/services/add_product_service.dart';
...
import 'package:syriacosmeticsmanger/features/shop/domain/services/shop_service.dart';
import 'package:syriacosmeticsmanger/features/shop/domain/services/shop_service_interface.dart';
import 'package:syriacosmeticsmanger/features/splash/domain/repositories/splash_repository.dart';
import 'package:syriacosmeticsmanger/features/bank_info/domain/repositories/bank_info_repository.dart';
import 'package:syriacosmeticsmanger/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/splash/domain/services/splash_service.dart';
import 'package:syriacosmeticsmanger/features/splash/domain/services/splash_service_interface.dart';
import 'package:syriacosmeticsmanger/features/transaction/domain/repositories/transaction_repository.dart';
...
import 'package:syriacosmeticsmanger/features/transaction/domain/services/transaction_service.dart';
...
import 'package:syriacosmeticsmanger/features/vat_management/domain/repositories/vat_repository.dart';
import 'package:syriacosmeticsmanger/features/vat_management/domain/repositories/vat_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/vat_management/domain/services/vat_service.dart';
...
import 'package:syriacosmeticsmanger/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:syriacosmeticsmanger/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:syriacosmeticsmanger/features/wallet/domain/services/wallet_service.dart';
